...
function CostComparison() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* 标题 */}
      <div className="card">
        <h1 className="text-2xl font-bold text-white mb-2">{t.costs.title}</h1>
      ...
      <div className="card bg-gradient-to-r from-green-500/10 to-primary-500/10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-green-500 font-semibold">{t.costs.deepseekTip}</p>
            <p className="text-slate-400 text-sm">
              {t.costs.deepseekTipDesc}
            </p>
          </div>
        </div>
      </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-slate-700">
                  <th className="text-left text-slate-400 py-2">{t.costs.model}</th>
                  <th className="text-right text-slate-400 py-2">{t.costs.inputPerK}</th>
                  <th className="text-right text-slate-400 py-2">{t.costs.outputPerK}</th>
                  <th className="text-right text-slate-400 py-2">{t.costs.exampleCost}</th>
                  <th className="text-right text-slate-400 py-2">{t.costs.vsGPT4o}</th>
                </tr>
              </thead>
              <tbody>
      ...
      {/* 使用建议 */}
      <div className="card">
        <h2 className="text-lg font-semibold text-white mb-4">{t.costs.recommendations}</h2>
        <div className="space-y-3">
          <div className="bg-slate-700/50 rounded-lg p-4">
            <p className="text-green-500 font-medium mb-2">✅ {t.costs.bestValue}</p>
            <p className="text-slate-400 text-sm">
              {t.costs.bestValueDesc}
            </p>
          </div>
          
          <div className="bg-slate-700/50 rounded-lg p-4">
            <p className="text-yellow-500 font-medium mb-2">⚡ {t.costs.fastCheap}</p>
            <p className="text-slate-400 text-sm">
              {t.costs.fastCheapDesc}
            </p>
          </div>
          
          <div className="bg-slate-700/50 rounded-lg p-4">
            <p className="text-primary-500 font-medium mb-2">🧠 {t.costs.complexTasks}</p>
            <p className="text-slate-400 text-sm">
              {t.costs.complexTasksDesc}
            </p>
          </div>
        </div>
      </div>
      ...
      {modelCosts && (
        <div className="card">
          <h2 className="text-lg font-semibold text-white mb-4">{t.costs.yourActualCosts}</h2>
          <p className="text-slate-400 text-sm mb-4">
            {t.costs.yourActualCostsDesc}
          </p>
